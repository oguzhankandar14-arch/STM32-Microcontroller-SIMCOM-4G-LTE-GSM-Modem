- This modem Works on different voltage levels , so thats why we have to use seperate power supply for gsm modem .
- This LDO is responsible for generating specific voltage on which this 4G LTE Modem works.
Parameters for selecting LDO IC : 
- Input Voltage : 5V x 1.5 = 7.5V(at least)
- Output Voltage : 3.3V
- Output Current
- Dropout Voltage 
- Quiescent Current 
